...
function () {
  function TabView(id) {
    var class_prefix = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
    var default_tab = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
    var expand_tabs = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
    var panel_heading_level = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 2;
    var panel_heading_class = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : undefined;
  ...
  _createClass(TabView, [{
    ...
    value: function previousTab() {
      ...
      var index = this.tabs.indexOf(this.currentTab); // check if it's 0 or the last element and create a new_index variable depending on the result.
